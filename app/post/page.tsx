...
export default function post() {
  ...
  const removeInput = (index: number) => {
    //index: numberとはindexには数値が入りますという意味
    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto w-full max-w-md px-5 pb-40 pt-6">
        <div className="px-5 pb-10 pt-6">
          <div className="mb-8">
            <h1 className="text-2xl font-bold tracking-sm text-slate-800">振り返りと目標</h1>
          ...
          <div className="mb-6">
            ...
            <div className="mt-3 space-y-3">
              {items.map(
                (
                  v,
                  i, //mapとはこの場合items配列のある一つの要素を取り出し, value , index という　[りんご　0番目]　というような感じで取り出せる
                ) => (
