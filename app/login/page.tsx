      ...
      <div className="mx-auto w-full max-w-md px-5 pb-40 pt-6">
        <div className="w-full">
          <div className="mt-20 flex flex-col items-center text-center">
            <h1 className="text-4xl font-bold tracking-tight text-slate-800">Kodo</h1>
          ...
          <div className="mt-8 space-y-3">
            <button
              ...
              className="h-14 w-full rounded-2xl bg-sky-500 text-sm font-semibold text-white shadow-sm"
            >
              ログインしてはじめる
            </button>
            ...
            <button
              ...
              className="h-12 w-full rounded-2xl border border-slate-200 text-sm font-semibold text-slate-600"
            >
              サインアップ
            </button>
          </div>
